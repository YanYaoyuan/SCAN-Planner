...
CONTROLLER_YAW_RATE_DEADBAND="${CONTROLLER_YAW_RATE_DEADBAND:-0.03}"
CONTROLLER_YAW_FILTER_TIME_CONSTANT="${CONTROLLER_YAW_FILTER_TIME_CONSTANT:-0.20}"
CONTROLLER_MAX_YAW_ACCELERATION="${CONTROLLER_MAX_YAW_ACCELERATION:-1.0}"
CONTROLLER_YAW_REVERSAL_THRESHOLD="${CONTROLLER_YAW_REVERSAL_THRESHOLD:-0.15}"
CONTROLLER_YAW_START_THRESHOLD="${CONTROLLER_YAW_START_THRESHOLD:-0.12}"
CONTROLLER_YAW_STOP_THRESHOLD="${CONTROLLER_YAW_STOP_THRESHOLD:-0.06}"
