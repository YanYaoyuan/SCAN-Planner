...
# Stopping generation of old CMake targets does not remove binaries already in
# a reused colcon install tree, so fail closed instead of silently shipping one.
